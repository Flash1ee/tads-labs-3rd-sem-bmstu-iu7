# Лабораторная работа №3 "Записи с вариантами, обработка таблиц"
...
### Вывод  
Алгоритмы хранения и обработки разреженных матриц эффективны по памяти при заполнении матрицы до 60 % ненулевыми элементами.  
